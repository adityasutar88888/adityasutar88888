...
- 🔢 **Calculator App** – Basic calculator using HTML, CSS & JS  
- 📝 **To-Do App** – Simple task manager with localStorage  
- 💬 **Real-Time Chat App** – Built with React + Firebase  
- 🛒 **Amazon Clone** – Frontend e-commerce site with React

➡️ [View my repositories »](https://github.com/adityasutar88888?tab=repositories)

---

### 🏆 Achievements

- 🥈 2nd Prize – Reverse Coding Competition at Yeshoda College

---

### 📫 Connect with Me

[![LinkedIn](https://img.shields.io/badge/-LinkedIn-blue?style=flat&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/aditya-sutar-115358308)
